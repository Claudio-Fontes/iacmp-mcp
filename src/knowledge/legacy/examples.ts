...
export const LEGACY_EXAMPLES: Example[] = [
  ...
  },
  {
    ...
    "notes": [
      ...
      "S3Client({}) sem endpoint explícito: o SDK resolve s3.amazonaws.com para o Gateway Endpoint automaticamente via route table — NUNCA passe endpoint customizado no construtor do S3Client, pois isso desvia do Gateway.",
